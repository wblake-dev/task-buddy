...
function createSurvey($conn, $title, $description, $reward, $questions) {
    ...
    // Insert the survey into the surveys table with JSON questions
    $insertSurveyQuery = "INSERT INTO surveys (title, description, questions, reward, created_by, created_at) VALUES (:title, :description, :questions, :reward, :created_by, NOW())";
...
<body class="bg-gray-50 min-h-screen">
    ...
    <script>
        ...
        function addQuestion() {
            ...
            // Initialize the question type (default is multiple choice)
            if (typeSelect) {
        ...
        function addOption(buttonElement) {
            ...
            const optionsDiv = optionsContainer.querySelector('.space-y-2');
            ...
            newOptionDiv.innerHTML = `
                <input type="text" name="questions[${questionIndex}][options][${optionIndex}][option_text]"
                    class="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition"
