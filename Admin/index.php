        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    <a href="../user/auth/register.php" class="bg-blue-600 text-white px-8 py-3 rounded-full hover:bg-blue-700 transition duration-300 text-lg font-semibold">
                        Get Started Now
                    </a>
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <a href="../user/auth/login.php"><i class="fas fa-user mr-2"></i>User Login</a>
                            <a href="admin_login.php"><i class="fas fa-user-shield mr-2"></i>Admin Login</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <main>
        ...
        <section class="py-20 bg-blue-600">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <a href="../user/auth/register.php" class="bg-white text-blue-600 px-8 py-3 rounded-full hover:bg-gray-100 transition duration-300 text-lg font-semibold inline-block">
                    Join Now
                </a>
            </div>
        </section>
