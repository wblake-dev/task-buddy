        ...
        <main>
            <div class="bg-white rounded-xl shadow-md p-6 mb-6">
                ...
                <form method="POST" action="" id="surveyForm">
                    <div class="mb-8">
                        <div class="mb-6">
                            <label for="title" class="block text-sm font-medium text-gray-700 mb-1">Survey
                                Title*</label>
                        ...
                        <div class="mb-6">
                            <label for="reward" class="block text-sm font-medium text-gray-700 mb-1">Reward
                                Amount*</label>
                            <div class="relative">
            ...
            <div class="rating-container mb-4 hidden">
                ...
                <div class="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div class="flex space-x-2">
                        <span
                            class="w-8 h-8 bg-red-200 rounded-full flex items-center justify-center text-sm font-medium">1</span>
                        <span
                            class="w-8 h-8 bg-orange-200 rounded-full flex items-center justify-center text-sm font-medium">2</span>
                        <span
                            class="w-8 h-8 bg-yellow-200 rounded-full flex items-center justify-center text-sm font-medium">3</span>
                        <span
                            class="w-8 h-8 bg-blue-200 rounded-full flex items-center justify-center text-sm font-medium">4</span>
                        <span
                            class="w-8 h-8 bg-green-200 rounded-full flex items-center justify-center text-sm font-medium">5</span>
                    </div>
